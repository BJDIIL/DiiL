...
using diil.web.Domain;using EIP.Common.Entities;
...
namespace EIP.System.Business.Permission
{
    ...
    ///     菜单按钮功能逻辑接口
    /// </summary>
    public class SystemMenuButtonFunctionLogic : AsyncLogic<SystemMenuButtonFunction>, ISystemMenuButtonFunctionLogic
    {
        #region 构造函数
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public async Task<IEnumerable<SystemMenuButtonFunctionOutput>> GetAllFunctions(GetAllFunctionsInput input)
        {
